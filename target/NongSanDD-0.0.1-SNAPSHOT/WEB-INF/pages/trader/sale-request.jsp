		...
		<table class="display nowrap responsive-table" id="sale_request">
			...
			<tbody>
				...
				<tr>
					...
					<td><img src="/NongSanDD/resources/images/partner-logo/1.png"></td>
					<td><ul>
					...
					<td>
						<select class="form-control form-control-lg action_option">
							...
							<option value="NhaBuon/chi-tiet-tin-ban?id=${data[1].id}&state=2"> Chi tiết</option>
...
$("#sale_request").on('change','.action_option', function () { 
    ...
    if (value >= 0) {
    	$.confirm({
	        ...
	        buttons: {
	            'Đồng Ý': function (){
	            	window.location.href = "NhaBuon/huy-yeu-cau?id=" + value;
	            },
	            cancel: function () {
	            }
	        }
