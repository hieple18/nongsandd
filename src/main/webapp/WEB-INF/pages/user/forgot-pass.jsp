...
<div class="container">
	...
	<div style="width: 350px; padding: 20px; margin: auto;">
		<form role="form" action="/NongSanDD/TempND/doi-mk" method="post"
			id="verify_form">
